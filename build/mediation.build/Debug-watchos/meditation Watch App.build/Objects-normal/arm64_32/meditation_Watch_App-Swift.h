...
#ifndef MEDITATION_WATCH_APP_SWIFT_H
#define MEDITATION_WATCH_APP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="meditation_Watch_App",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC20meditation_Watch_App24WatchConnectivityManager")
...
@class WCSession;
@class NSString;
@interface WatchConnectivityManager (SWIFT_EXTENSION(meditation_Watch_App)) <WCSessionDelegate>
...
SWIFT_CLASS("_TtC20meditation_Watch_App19WatchWorkoutManager")
@interface WatchWorkoutManager : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class HKLiveWorkoutBuilder;
@class HKSampleType;
@interface WatchWorkoutManager (SWIFT_EXTENSION(meditation_Watch_App)) <HKLiveWorkoutBuilderDelegate>
...
@class NSDate;
@interface WatchWorkoutManager (SWIFT_EXTENSION(meditation_Watch_App)) <HKWorkoutSessionDelegate>
